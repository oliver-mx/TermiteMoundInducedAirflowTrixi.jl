...
First, we need to choose the system of equations that describes the dynamics. It is optional to set specific parameter values:
```julia
...
## Plane code
 ...
 ```julia
julia> # add full code & png of the results
```